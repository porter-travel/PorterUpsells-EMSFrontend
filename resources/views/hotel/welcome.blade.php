    ...
    <div class="mt-20">
        <div class="bg-blue px-8 pt-20 pb-12 max-w-[500px] mx-auto rounded-3xl relative">
            <div class="absolute -top-10 bg-gold px-4 py-6 left-1/2 -translate-x-1/2 rounded-3xl">
                <img style="width: 80px; height: 60px; object-fit: contain" src="{{$hotel->logo}}" alt="hotel" class=""/>
            </div>
            ...
            <form method="post" action="/createSession">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="booking-ref" class="block mt-1 w-full p-4" type="text" name="booking_ref" :value="old('booking_ref')"
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="arrival-date" class="block mt-1 w-full p-4" type="date" name="arrival_date" :value="old('arrival_date')"
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="email-address" class="block mt-1 w-full p-4" type="email" name="email_address" :value="old('email_address')"
